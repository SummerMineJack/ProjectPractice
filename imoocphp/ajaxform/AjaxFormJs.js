            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.code == 200) {
                        ...
                        createPageNumber(isLastPage);
                    }
                },
            });
        }

        function createPageNumber(allPageNumbers) {
            var strhtml = "";
            for (var i = 1; i <= allPageNumbers; i++) {
                strhtml += "<a href='javascript:void(0)' style='size: 100px'>" + i + "</a> ";
            }
            $("#showPageNumber").html(strhtml);
        };
        $(document).on('click', "a", function () {
            selAll4Page($(this).text());
        });
